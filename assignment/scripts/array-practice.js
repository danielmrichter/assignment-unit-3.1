...
let favoriteFoods = ['pasta', 'tacos', 'butternut squash', 'fried rice'];
...
let lastAnimalDifferent = animalArray[animalArray.length - 1];
console.log('Last animal expressed differently is ', lastAnimalDifferent);
...
console.log('Removed the first color ', this.firstColor);
console.log('The colors are now: ', colors);
...
console.log('stringified: ', gemString);
...
console.log('now some colorful gems: ', colorfulGems);
